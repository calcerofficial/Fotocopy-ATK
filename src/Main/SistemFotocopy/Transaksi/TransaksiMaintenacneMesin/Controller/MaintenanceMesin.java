package SistemFotocopy.Transaksi.TransaksiMaintenacneMesin.Controller;

import Database.DBConnection;
import SistemFotocopy.Transaksi.TransaksiMaintenacneMesin.Dataclass.DataMaintenanceModel;
...
public class MaintenanceMesin implements Initializable {
    ...
    @FXML
    private TableColumn<DataMaintenanceModel, String> colAksi, colDeskripsi, colIdMaintenance,
    ...
    @FXML
    private TableView<DataMaintenanceModel> tblMaintenance;
    ...
    // Data untuk tabel
    private ObservableList<DataMaintenanceModel> maintenanceDataList = FXCollections.observableArrayList();
    private ObservableList<DataMaintenanceModel> currentPageData = FXCollections.observableArrayList();
    private ObservableList<String> mesinList = FXCollections.observableArrayList();

    // SortedList untuk sorting
    private SortedList<DataMaintenanceModel> sortedData;
    ...
    private double getSaldoKas() {
        String query = "SELECT dbo.f_SaldoKas() AS Saldo";
    ...
    private void applyPagination() {
        ...
        if (sortedData == null) {
            sortedData = new SortedList<>(maintenanceDataList, (o1, o2) -> {
    ...
    private void setupTableColumns() {
        ...
        colStatus.setCellFactory(col -> new TableCell<DataMaintenanceModel, String>() {
            @Override
        ...
        colAksi.setCellFactory(col -> new TableCell<DataMaintenanceModel, String>() {
...

            {
                ...
                btnSelesai.setOnAction(event -> {
                    DataMaintenanceModel data = getTableView().getItems().get(getIndex());
    ...
    private void loadMaintenanceData() {
        ...
        try (Statement stmt = conn.createStatement();
             ResultSet rs = stmt.executeQuery(query)) {
            while (rs.next()) {
                DataMaintenanceModel data = new DataMaintenanceModel(
    ...
    // SHOW POPUP SELESAI
    // =============================================================
    private void showPopupSelesai(DataMaintenanceModel data) {
